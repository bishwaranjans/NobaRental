...
1. **Registration of Car Pickup**:
   ...
   - Customer SSN: Validated as exactly 11 digits (masked as `****** 78901` in API responses); it is not available as a booking search field because of security.
...
The system implements Free tier OAuth2 Machine-to-Machine (M2M) authentication and scope-based authorization with **Auth0**:
